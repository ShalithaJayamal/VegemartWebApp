<html>
    ...
    <div class="container">
    <form action="<?php $this->load->helper('url'); echo site_url('cVegetables/add');?>" method="POST">
        ...
        <div class="form-group">
        <label for="maxBuy">Buying price</label>
        <input type="text" class="form-control" id="maxBuy" placeholder="Enter buying price" name="buyPrice">
        </div>

        <div class="form-group">
        <label for="minBuy">Selling price</label>
        <input type="text" class="form-control" id="minBuy" placeholder="Enter selling price" name="sellPrice">
        </div>
