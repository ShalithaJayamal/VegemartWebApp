<html>
    ...
    <div class="container">
    <form action="<?php $this->load->helper('url'); echo site_url('cBuyers/add');?>" method="POST">
        <div class="form-group">
        <label for="name">Buyer Name</label>
        <input type="text" class="form-control" id="name" placeholder="Enter buyer's name" name="name">
        </div>

        <div class="form-group">
        <label for="maxBuy">Telephone number</label>
        <input type="text" class="form-control" id="maxBuy" placeholder="Enter telephone number" name="tp">
        </div>

        <div class="form-group">
        <label for="minBuy">Address</label>
        <input type="text" class="form-control" id="minBuy" placeholder="Enter address" name="addr">
        </div>
